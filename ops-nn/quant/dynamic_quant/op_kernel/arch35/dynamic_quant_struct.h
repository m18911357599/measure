...
#define TPL_PER_CHANNEL_FULL_LOAD 7
#define TPL_PER_CHANNEL_RECOMPUTE 8
#define TPL_PER_CHANNEL_SPLIT_M 9
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(quantMode, 4, ASCENDC_TPL_UI_LIST,
                          ...
                          TPL_PER_CHANNEL_FULL_LOAD, TPL_PER_CHANNEL_RECOMPUTE, TPL_PER_CHANNEL_SPLIT_M),
...
ASCENDC_TPL_SEL(
    ...
    // 7. PER_CHANNEL_FULL_LOAD : 1*1*2*2
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(useDb, ASCENDC_TPL_UI_LIST, TPL_USE_DB_TRUE),
        ASCENDC_TPL_UINT_SEL(quantMode, ASCENDC_TPL_UI_LIST, TPL_PER_CHANNEL_FULL_LOAD),
        ASCENDC_TPL_UINT_SEL(hasSmooth, ASCENDC_TPL_UI_LIST,
                             TPL_HAS_SMOOTH_FALSE, TPL_HAS_SMOOTH_TRUE),
        ASCENDC_TPL_UINT_SEL(isSymmetrical, ASCENDC_TPL_UI_LIST,
                             TPL_IS_SYMMERTRICAL_FALSE, TPL_IS_SYMMERTRICAL_TRUE)
    ),
    // 8. PER_CHANNEL_RECOMPUTE : 1*1*2*2
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(useDb, ASCENDC_TPL_UI_LIST, TPL_USE_DB_TRUE),
        ASCENDC_TPL_UINT_SEL(quantMode, ASCENDC_TPL_UI_LIST, TPL_PER_CHANNEL_RECOMPUTE),
        ASCENDC_TPL_UINT_SEL(hasSmooth, ASCENDC_TPL_UI_LIST,
                             TPL_HAS_SMOOTH_FALSE, TPL_HAS_SMOOTH_TRUE),
        ASCENDC_TPL_UINT_SEL(isSymmetrical, ASCENDC_TPL_UI_LIST,
                             TPL_IS_SYMMERTRICAL_FALSE, TPL_IS_SYMMERTRICAL_TRUE)
    ),
    // 9. PER_CHANNEL_SPLIT_M : 1*1*2*2
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(useDb, ASCENDC_TPL_UI_LIST, TPL_USE_DB_TRUE),
        ASCENDC_TPL_UINT_SEL(quantMode, ASCENDC_TPL_UI_LIST, TPL_PER_CHANNEL_SPLIT_M),
        ASCENDC_TPL_UINT_SEL(hasSmooth, ASCENDC_TPL_UI_LIST,
                             TPL_HAS_SMOOTH_FALSE, TPL_HAS_SMOOTH_TRUE),
        ASCENDC_TPL_UINT_SEL(isSymmetrical, ASCENDC_TPL_UI_LIST,
                             TPL_IS_SYMMERTRICAL_FALSE, TPL_IS_SYMMERTRICAL_TRUE)
