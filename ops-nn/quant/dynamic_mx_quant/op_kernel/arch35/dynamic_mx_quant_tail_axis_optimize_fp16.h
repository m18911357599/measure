...
/*!
 * \file dynamic_mx_quant_tail_axis_optimize_fp16.h
 * \brief
 */

#ifndef DYNAMIC_MX_QUANT_TAIL_AXIS_OPTIMIZE_FP16_H
#define DYNAMIC_MX_QUANT_TAIL_AXIS_OPTIMIZE_FP16_H
...
class DynamicMxQuantTailAxisOptimizeFp16 {
public:
    __aicore__ inline DynamicMxQuantTailAxisOptimizeFp16()
    {}
...
private:
    ...
    template <AscendC::RoundMode toBf16RoundMode, AscendC::RoundMode roundMode>
    __aicore__ inline void CommonFlowProcess(const LoopParam& runningParams);
...
private:
    ...
    int64_t ubFactorDim0_ = 0;
    int64_t ubFactorDim1_ = 0;

    int64_t blockFactorDim0_ = 0;
    int64_t blockFactorDim1_ = 0;

    int64_t blockFactorDim0Tail_ = 0;
    int64_t ubFactorDim0Tail_ = 0;

    int64_t blockIdx_ = 0;
    int64_t totalCoreNum_ = 0;
    int64_t usedCoreNum_ = 0;

    int64_t coreDim0RowCount_ = 0;
    int64_t tailCoreDim1NotSplitDim1_ = 0;
    ...
    int64_t isSplitDim1_ = 0;

    int64_t blockFactorDim1ForSplitDim1_ = 0;
    int64_t tailBlockFactorDim1ForSplitDim1_ = 0;
    int64_t blockCountDim1EachCoreForSplitDim1_ = 0;
    int64_t tailLoopBlockDim1ForSplitDim1_ = 0;
    int64_t tailLoopBlockTailCoreDim1ForSplitDim1_ = 0;

    int64_t cutNumberForDim1_ = 0;
    int64_t inputShapeDim1_ = 0;
    uint16_t f4Emax_ = 0;
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::Init(
    GM_ADDR x, GM_ADDR y, GM_ADDR mxScale, GM_ADDR workspace, const DynamicMxQuantTilingData* tilingData)
{
    ...
    pipe_.InitBuffer(
        outQueue_, DB_BUFFER,
        (ubFactorDim0_ * ubFactorDim1_ * blockSize_ / DIGIT_TWO + vlForHalfNumber_ - 1) / vlForHalfNumber_ *
            vlForHalfNumber_);
    pipe_.InitBuffer(
    ...
    pipe_.InitBuffer(
        outBuffer_, (ubFactorDim0_ * ubFactorDim1_ * blockSize_ / DIGIT_TWO + vlForHalfNumber_ - 1) / vlForHalfNumber_ *
                        vlForHalfNumber_);
    ...
    if (blockIdx_ >= tailDim0StartCoreIdx_) {
        currentBlockFactorDim0_ = blockFactorDim0Tail_ - 1;
    }
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ParseTilingData(
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::Process()
{
...
template <typename T, typename U>
template <AscendC::RoundMode toBf16RoundMode, AscendC::RoundMode roundMode>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::CommonFlowProcess(const LoopParam& runningParams)
{
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ProcessDim1NotSplit()
{
    LoopParam runningParams;
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ProcessDim1SplitNormalCore()
{
    LoopParam runningParams;
    runningParams.runningBlockFactorDim0 = currentBlockFactorDim0_;
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ProcessDim1SplitTailCore()
{
    LoopParam runningParams;
    runningParams.runningBlockFactorDim0 = currentBlockFactorDim0_;
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ProcessDim1Split()
{
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::CopyIn(
    int64_t dim0LoopIdx, int64_t dim1LoopIdx, int64_t usedFactorDim0, int64_t usedFactorDim1, int64_t isContainPad)
{
...
template <typename T, typename U>
template <AscendC::RoundMode toBf16RoundMode, AscendC::RoundMode roundMode>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ComputeData(
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t i = 0; i < loopNum; i++) {
            ...
            if constexpr (IsSame<T, half>::value) {
                ...
                // vdExp0
                MicroAPI::Cast<float, T, castTraitF16toFp32Zero>(vdExp0ZeroFP32, vdExp0, dataMaskB16);
                MicroAPI::Cast<float, T, castTraitF16toFp32One>(vdExp0OneFP32, vdExp0, dataMaskB16);
                ...
                // vdExp1
                MicroAPI::Cast<float, T, castTraitF16toFp32Zero>(vdExp1ZeroFP32, vdExp1, dataMaskB16);
                MicroAPI::Cast<float, T, castTraitF16toFp32One>(vdExp1OneFP32, vdExp1, dataMaskB16);
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ComputeMaxExp(
    __ubuf__ T* srcAddr, __ubuf__ uint16_t* maxExpAddr, uint32_t totalCountInUB, uint16_t loopNum)
{
    __VEC_SCOPE__
    {
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ComputeScale(
    __ubuf__ uint16_t* maxExpAddr, __ubuf__ uint16_t* mxScaleLocalAddr, __ubuf__ uint16_t* halfScaleLocalAddr,
    uint32_t totalScaleInUB, uint16_t loopNumScale)
{
    __VEC_SCOPE__
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::DeletePadData(
...
template <typename T, typename U>
template <AscendC::RoundMode toBf16RoundMode, AscendC::RoundMode roundMode>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::Compute(
...
template <typename T, typename U>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::CopyOut(
    int64_t dim0LoopIdx, int64_t dim1LoopIdx, int64_t usedFactorDim0, int64_t usedFactorDim1, int64_t isContainPad)
{
...
template <typename T, typename U>
template <RoundMode toBf16RoundMode, RoundMode roundMode>
__aicore__ inline void DynamicMxQuantTailAxisOptimizeFp16<T, U>::ComputeFP4FromHalf(MicroAPI::RegTensor<float>& Reg)
{
...
#endif // DYNAMIC_MX_QUANT_TAIL_AXIS_OPTIMIZE_FP16_H